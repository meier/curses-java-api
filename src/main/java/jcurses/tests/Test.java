...
public class Test extends Window implements ItemListener, ActionListener, ValueChangedListener,
    WindowListener, WidgetsConstants
{
  ...
  public void actionPerformed(ActionEvent event)
  {
    ...
    if (w == _b1)
    {
      ...
      FileDialog dial = new FileDialog("File location");
